...
class DeserializeRegistrationTest extends TestCase
{
    public function testHealthWelfareRegistrationIsDeserialized()
    {
        ...
        $xmlDocument = file_get_contents('module/Opg/tests/Fixtures/XmlDocuments/HealthWelfare/MinimalRegistration.xml');

        $registrationXmlDeserializer = new HealthWelfareRegistrationXmlDeserializer($interfaceToClassMapProvider, $xmlDeserializer, $xmlValidator);
        $registration = $registrationXmlDeserializer->deserialize($xmlDocument);

        $this->assertTrue($registration instanceof HealthWelfareRegistration);
    ...
    public function testHealthWelfareRegistrationIsDeserializedWithMultipleApplicants()
    {
        $domDocumentFactory = new DomDocumentFactory();
        $domDocumentLoader  = new DomDocumentLoader($domDocumentFactory);
        ...
        $xmlDocument = file_get_contents('module/Opg/tests/Fixtures/XmlDocuments/HealthWelfare/MinimalRegistrationWithMultipleApplicants.xml');
